...
Log friction to the relevant `beads` issue notes or `~/.oro/projects/<name>/decisions&discoveries.md` if it's a broader insight.
...
1. **File issues** — Create `beads` entries for remaining/discovered work
