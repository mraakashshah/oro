...
**Date:** 2026-02-19
**Status:** SUPERSEDED — brainstorming/beadcraft skill updates landed; adversarial-spec-review skill exists separately; CLI items (oro run, oro verify-coverage) deferred indefinitely.
