...
- **For TUI apps** (Codex, Codex): split text and Enter with a delay — fast text+Enter may be treated as paste:
...
- Wait for patterns: `.Codex/skills/tmux/scripts/wait-for-text.sh -t session:0.0 -p 'pattern'`
