...
class TestHandlePostToolUseBatching:
    ...
    def test_5_rapid_beads_produce_1_notification(self, tmp_path):
        ...
        # Simulate 5 rapid oro bead create calls at t=0,1,2,3,4 (all within 30s window)
        base_ts = 1000.0
        with (
        ...
        # In real usage, the next oro bead create (or a timer) would trigger flush.
        # We simulate this by calling handle_post_tool_use with no new oro bead create
        # but after the window — but since the hook only fires on oro bead create,
        ...
        with (
            ...
            # A new oro bead create after window → triggers flush of accumulated beads
