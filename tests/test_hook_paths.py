...
def test_with_env_vars():
    ...
    try:
        ...
        decisions_file = os.path.join(proj_dir, "decisions&discoveries.md")
        assert decisions_file == "/tmp/test-oro/projects/testproj/decisions&discoveries.md"
    finally:
...
def test_without_env_vars():
    ...
    decisions_file = os.path.join(_pd2, "decisions&discoveries.md") if _pd2 else "docs/decisions&discoveries.md"
    assert decisions_file == "docs/decisions&discoveries.md"
...
def test_learning_analysis_constant_with_env():
    ...
    try:
        ...
        decisions = os.path.join(_pd, "decisions&discoveries.md")
        assert decisions == "/tmp/test-oro/projects/myproject/decisions&discoveries.md"
    finally:
        os.environ.pop("ORO_HOME", None)
        os.environ.pop("ORO_PROJECT", None)
